...
# # print(sensorsData)
# # sensorsData.update({"Direction":25, "Speed":10, "Direction_max":24, "Speed_max":34, "Battery":0})

# # Joue le message audio sur la radio
# # radio.playVoiceMessage(sensorsData)
# # t = attiny.read(15)
# # print(int.from_bytes(t[:2], byteorder='big', signed=False))
# # print(int.from_bytes(t[2:4], byteorder='big', signed=False))
# # print(int.from_bytes(t[4:6], byteorder='big', signed=False))
# # print(int.from_bytes(t[6:8], byteorder='big', signed=False)/100)
# # print(int.from_bytes(t[8:10], byteorder='big', signed=False)/100)
# # print(int.from_bytes(t[10:12], byteorder='big', signed=False)/100)
# # print(int.from_bytes(t[12:14], byteorder='big', signed=False))
# # print(t[14])
# # print(sensorsData)
# # print(mkrfox.read("error"))
# # sleep(1)
# # print(mkrfox.read("state"))
# # sleep(1)
...
# print(state)
# while(state & 0x02 != 2): # On attends que l'heure soit actualisé par le MKRFOX
#     state = mkrfox.read("state")
#     print(state)
#     sleep(1)
